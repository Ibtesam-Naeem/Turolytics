...
class BouncieWebhookLog(Base):
    ...
    event_type = Column(String(50), nullable=False, index=True, comment="Webhook event type (e.g., 'new_mil_event')")
    imei = Column(String(50), nullable=True, index=True, comment="Device IMEI")
