# ------------------------------ IMPORTS ------------------------------
from sqlalchemy import Column, Integer, SmallInteger, ForeignKey, DateTime, String, Text, func, Index
...
class UserSession(Base):
    ...
    is_active = Column(SmallInteger, default=1, nullable=False, comment="Whether session is active (1=active, 0=revoked)")
